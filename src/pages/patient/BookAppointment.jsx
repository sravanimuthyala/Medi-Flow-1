            ...
            return (
              <button
                ...
                className={`flex items-center gap-3 p-4 rounded-xl border-2 transition-all ${
                  visitType === t.value ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                }`}
              >
          ...
          {getNext7Days().map(d => {
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center min-w-[52px] p-2.5 rounded-xl border-2 transition-all ${
